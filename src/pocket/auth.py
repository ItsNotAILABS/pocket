...
PORTAL_DEVICE_PATHS = frozenset({
    ...
    "/api/phoneai/work/stream",
    "/v1/phoneai/code-desk",
    "/v1/phoneai/codedesk",
    "/api/phoneai/code-desk",
    "/v1/phoneai/code-desk/repos",
    "/api/phoneai/code-desk/repos",
