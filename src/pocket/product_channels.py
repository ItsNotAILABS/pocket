...
def channels() -> Dict[str, Any]:
    ...
    return {
        ...
        "channels": [
            {
                ...
                "how_start": [
                    ...
                    "Download an entitled desktop release",
                    "Optionally pair a local computer with a one-time code",
                ],
            ...
            },
            {
                ...
                "how_start": [
                    "Install POCKET-Setup for x64 or ARM64",
                    "Open the POCKET shortcut",
                    "Use POCKET Local for the bundled local body",
                    "Use POCKET Cloud for the independent account body",
                ],
                "url_local": "http://127.0.0.1:8787/desk",
                "download": {
                    "account_page": "/get",
                    "release_api": "/api/releases",
                    "legacy_host_page": "/download",
                },
            ...
            },
            {
                ...
                "how_start": [
                    "Open the POCKET Edge desktop or Start-menu shortcut",
                    "The launcher verifies or starts the local body",
                    "Microsoft Edge opens with --app against the selected trusted origin",
                ],
                "url_local": "http://127.0.0.1:8787/desk",
            ...
            },
            {
                ...
                "how_start": [
                    "Use a user session, scoped API key, or restricted device credential",
                    "Discover capabilities before invoking them",
                    "Use the cloud relay for queued paired-device work",
                ],
        ...
        "api": {
            ...
            "architecture": "GET /v1/product/architecture",
            "catalog": "GET /v1/api",
            "health": "GET /health",
...
def user_home_brief() -> Dict[str, Any]:
    ...
    return {
        ...
        "open": {
            "local_desk": "http://127.0.0.1:8787/desk",
            "cloud_account": "https://app.pocket.medinatechlabs.net",
            "channels": "/v1/product/channels",
            "architecture": "/v1/product/architecture",
        },
        "version": __version__,
    }
