...
def _desk_agents() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _e(
            "spark",
            "Spark",
            "Reagent Spark · qwen3.8-27b on this PC",
            kind="desk",
            group="Primary",
            color="#a855f7",
            desk_mode="spark",
            engine="spark",
            harness=True,
            blurb="Spark API — writes local files, GitHub via gh, virtual computer. Same as the group.",
            surfaces=["desk", "phone"],
            aliases=["reagent-spark", "qwen-spark", "@spark"],
        ),
        _e(
            "muse_spark",
            "Muse Spark",
            ...
            engine="muse_spark",
            harness=True,
            blurb="Meta Muse lanes. Group Spark is the Spark button.",
            surfaces=["desk", "phone"],
            aliases=["muse", "muse-spark", "musespark"],
        ),
        # Build / ship
