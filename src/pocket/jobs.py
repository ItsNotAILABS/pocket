...
VALID_MODES = frozenset({
    ...
    "logic", "logic_prover", "prove", "pattern", "pattern_forge", "xray",
    "world", "world_model", "intelligence_world", "imagine", "imagine_studio", "visua",
    "genetic", "genetic_flow", "internal", "internal_models", "foundations",
    "bot", "bots", "teammate",
